...
class AudioStreamGenerator:
    ...
    def run(self, input: tp.Iterator[tp.Any], **kwargs) -> tp.Iterable[sr.AudioData]:
        with self.register_stop_handler():
            yield from self.generate()

    async def async_run(self, input: tp.AsyncIterator[tp.Any], **kwargs) -> tp.AsyncIterator[sr.AudioData]:
